...
// The screen buffer:
volatile uint8_t led_buf[11][7][3];
...
const uint8_t led_map[15][15][3] = {
                                    ...
                                    { {7, 6, 0}, {7, 6, 0}, {7, 6, 0}, {10, 0, 2}, {10, 0, 1}, {10, 0, 0}, {9, 0, 2}, {9, 0, 1}, {9, 0, 0}, {8, 4, 2}, {8, 4, 1}, {8, 4, 0}, {7, 0, 2}, {7, 0, 1}, {7, 0, 0}},
                                    { {10, 5, 2}, {10, 5, 1}, {10, 5, 0}, {10, 1, 2}, {10, 1, 1}, {10, 1, 0}, {10, 2, 2}, {10, 2, 1}, {10, 2, 0}, {10, 4, 2}, {10, 4, 1}, {10, 4, 0}, {10, 3, 2}, {10, 3, 1}, {10, 3, 0}},
                                    ...
                                    { {8, 3, 2}, {8, 3, 1}, {8, 3, 0}, {8, 0, 2}, {8, 0, 1}, {8, 0, 0}, {8, 1, 2}, {8, 1, 1}, {8, 1, 0}, {8, 2, 2}, {8, 2, 1}, {8, 2, 0}, {8, 5, 2}, {8, 5, 1}, {8, 5, 0}},
