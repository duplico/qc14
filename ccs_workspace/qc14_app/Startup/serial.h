...
#define PROTO_STATE_PLUGGING 1
#define PROTO_STATE_IDLE 2
#define PROTO_STATE_RTS_WAIT 3
#define PROTO_STATE_CTS_WAIT 4
#define PROTO_STATE_RTS_OUT 5
#define PROTO_STATE_CTS_OUT 6
